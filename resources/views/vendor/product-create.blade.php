...
<x-app-layout>
    <section class="container overflow-y-scroll mx-auto max-w-screen-sm min-h-screen max-h-screen md:max-w-screen-2xl xl:max-w-screen-sm">
        <div class="container p-6 mx-auto">
            <form action="{{route('kantin.product.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="grid grid-cols-1 gap-4 mt-5">
                    <div class="col-span-1 p-2 w-full h-auto rounded-xl border-2 shadow-xl">
                        <div class="mb-5">
                            ...
                            <x-text-input type="text" id="product_name" required name="product_name" placeholder="Masukkan Nama Menu" class="block p-2 w-full text-xs text-black bg-white rounded-lg border border-[#d9d9d9] focus:ring-primary focus:border-primary "></x-text-input>
                            <x-input-error :messages="$errors->get('product_name')" class="mt-2" />
                        </div>
                        <div class="mb-5">
                            <label for="deskripsi_product" class="block mb-2 text-sm font-extrabold text-black">Deskripsi Menu</label>
                            <textarea id="deskripsi_product" required name="product_description" rows="4" class="block p-2.5 w-full text-sm text-black bg-transparent rounded-lg border border-gray-300 focus:ring-primary focus:border-primary" placeholder="Tulis Deskripsi Menu..."></textarea>
                        ...
                        <div class="mb-5">
                            ...
                            <x-text-input type="text" id="currency-field" data-type="currency" required name="product_price" placeholder="Rp." type-currency="IDR" class="block p-2 w-full text-xs text-black bg-white rounded-lg border border-[#d9d9d9] focus:ring-primary focus:border-primary "></x-text-input>
                        </div>
                        <div id="quantity" class="mb-5">
                            <label for="currency-field" class="block mb-2 text-sm font-extrabold text-black">Jumlah Stock Tersedia</label>
                                <div class="relative flex items-center max-w-[10rem]">
                                    ...
                                    <input type="number" name="product_stock" min="0" id="quantity-input" data-input-counter aria-describedby="helper-text-explanation" class="block py-2.5 w-full h-11 text-sm text-center text-gray-900 bg-transparent border-x-0 border-[#d9d9d9]" placeholder="0" required />
                        ...
                        <div class="mb-5">
                            ...
                            <div class="flex items-center text-[#9d9d9d]">
                                <input type="radio" id="makanan" name="category_id" required value="1" class="mr-2 focus:border-primary focus:ring-primary"  >
                                <div>
                                    Makanan
                                </div>
                            </div>
                            <div class="flex items-center text-[#9d9d9d]">
                                <input type="radio" id="minuman" name="category_id" required value="2" class="mr-2 focus:border-primary focus:ring-primary"  >
                                <div>
                                    Minuman
                                </div>
                            </div>
                            <div class="flex items-center text-[#9d9d9d]">
                                <input type="radio" id="snack" name="category_id" required value="3" class="mr-2 focus:border-primary focus:ring-primary"  >
                                <div>
                                    Snack
                                </div>
                            </div>
                        ...
                        <div class="mb-5">
                            ...
                            <x-text-input type="text" id="kalori" required name="kalori" placeholder="Masukkan Kandungan Kalori" class="block p-2 w-full text-xs text-black bg-white rounded-lg border border-[#d9d9d9] focus:ring-primary focus:border-primary "></x-text-input>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="flex items-center text-[#9d9d9d] mb-1">
                                <input type="checkbox" name="kandungan_gizi[]" value="karbohidrat" class="mr-2 focus:border-primary focus:ring-primary" >
                                <div class="capitalize">
                                    Karbohidrat
                                </div>
                            </div>
                            <div class="flex items-center text-[#9d9d9d] mb-1">
                                <input type="checkbox" name="kandungan_gizi[]" value="protein" class="mr-2 focus:border-primary focus:ring-primary" >
                                <div class="capitalize">
                                    Protein
                                </div>
                            </div>
                            <div class="flex items-center text-[#9d9d9d] mb-1">
                                <input type="checkbox" name="kandungan_gizi[]" value="lemak" class="mr-2 focus:border-primary focus:ring-primary" >
                                <div class="capitalize">
                                    lemak
                                </div>
                            </div>
                            <div class="flex items-center text-[#9d9d9d] mb-1">
                                <input type="checkbox" name="kandungan_gizi[]" value="serat" class="mr-2 focus:border-primary focus:ring-primary" >
                                <div class="capitalize">
                                    serat
                                </div>
                            </div>
                            <div class="flex items-center text-[#9d9d9d] mb-1">
                                <input type="checkbox" name="kandungan_gizi[]" value="mineral" class="mr-2 focus:border-primary focus:ring-primary" >
                                <div class="capitalize">
                                    mineral
                                </div>
                            </div>
                            <div class="flex items-center text-[#9d9d9d] mb-1">
                                <input type="checkbox" name="kandungan_gizi[]" value="zat besi" class="mr-2 focus:border-primary focus:ring-primary" >
                                <div class="capitalize">
                                    zat besi
                                </div>
                            </div>
                            <div class="flex items-center text-[#9d9d9d] mb-1">
                                <input type="checkbox" name="kandungan_gizi[]" value="vitamin A" class="mr-2 focus:border-primary focus:ring-primary" >
                                <div class="capitalize">
                                    vitamin A
                                </div>
                            </div>
                            <div class="flex items-center text-[#9d9d9d] mb-1">
                                <input type="checkbox" name="kandungan_gizi[]" value="Vitamin B" class="mr-2 focus:border-primary focus:ring-primary" >
                                <div class="capitalize">
                                    Vitamin B
                                </div>
                            </div>
                            <div class="flex items-center text-[#9d9d9d] mb-1">
                                <input type="checkbox" name="kandungan_gizi[]" value="Vitamin C" class="mr-2 focus:border-primary focus:ring-primary" >
                                <div class="capitalize">
                                    Vitamin C
                                </div>
                            </div>
                            <div class="flex items-center text-[#9d9d9d] mb-1">
                                <input type="checkbox" name="kandungan_gizi[]" value="Vitamin D" class="mr-2 focus:border-primary focus:ring-primary" >
                                <div class="capitalize">
                                    Vitamin D
                                </div>
                            </div>
                            <div class="flex items-center text-[#9d9d9d] mb-1">
                                <input type="checkbox" name="kandungan_gizi[]" value="kalsium" class="mr-2 focus:border-primary focus:ring-primary" >
                                <div class="capitalize">
                                    kalsium
                                </div>
                            </div>
                ...
                <input type="hidden" value="{{$kantin->id}}" name="kantin_id">
